...
CREATE TABLE "Inscription" (
    "codeFormation" TEXT NOT NULL,
    "codeApprenant" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Inscription_codeFormation_codeApprenant_key" ON "Inscription"("codeFormation", "codeApprenant");
...
-- AddForeignKey
ALTER TABLE "Inscription" ADD CONSTRAINT "Inscription_codeApprenant_fkey" FOREIGN KEY ("codeApprenant") REFERENCES "Apprenant"("codeApprenant") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Inscription" ADD CONSTRAINT "Inscription_codeFormation_fkey" FOREIGN KEY ("codeFormation") REFERENCES "Formation"("codeFormation") ON DELETE CASCADE ON UPDATE CASCADE;
